...
public class StreamsBigDecimalExemplo {
    ...
    public static List<BigDecimal> imprimeNumerosAcima50(List<BigDecimal> numeros){
        return numeros.stream()
    ...
    public static List<BigDecimal> numeros0a50comDesconto20PorCento(List<BigDecimal> numeros){
        return numeros.stream()
    ...
    public static List<BigDecimal> numeros30a60comDesconto30PorCento(List<BigDecimal> numeros){
        return numeros.stream()
    ...
    public static List<BigDecimal> numeros50a100comDesconto35PorCento(List<BigDecimal> numeros){
        return numeros.stream()
    ...
    public static BigDecimal somaNumeros1QuartilE3Quartil(List<BigDecimal> numeros){
    ...
    public static List<BigDecimal> imprimeNumeros2Quartil(List<BigDecimal> numeros){
        return numeros.stream()
